...
function main() {
  ...
  console.log("PASS launch-dashboard server integration: admin guards, protected route, discoverability link, fail-closed marker, and startup composition are preserved.");
}
