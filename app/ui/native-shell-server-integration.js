function integrateNativeShellServerSource(source) {
  ...
  if (
    ...
    input.includes('app.get("/voice-mobile-fast-path.js"') &&
    input.includes('app.get("/voice-safe-bridge.js"') &&
    ...
    input.includes('voice-mobile-fast-path.js?v=2') &&
    input.includes('voice-safe-bridge.js?v=200') &&
    ...
    input.includes('injectSimpleShell') &&
    input.includes('injectVoiceListenControl') &&
    input.includes('injectVoiceCanonicalText') &&
