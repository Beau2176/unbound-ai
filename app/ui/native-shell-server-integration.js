function integrateNativeShellServerSource(source) {
  ...
  if (
    ...
    input.includes('app.get("/voice-readability-fix.js"') &&
    ...
    input.includes('voice-readability-fix.js?v=100') &&
