function integrateNativeShellServerSource(source) {
  ...
  if (
    ...
    input.includes('health-status.js?v=110') &&
    input.includes('runtime-capabilities.js?v=120') &&
    input.includes('device-inspector.js?v=120') &&
    input.includes('action-bridge.js?v=120') &&
